  ...
  changeAreaAttributes() {
    ...
    g.selectAll('circle')
      .attr('r', (d, i) => {
        ...
        return Math.max(Math.sqrt(d[this.state.dates[this.state.year_month_idx]] / areaInfo[d.Province_State].population * 100000) * 6, 0);
      });
    g.selectAll('text')
      .style('font-size', (d, i) => {
        return Math.max(Math.sqrt(d[this.state.dates[this.state.year_month_idx]] / areaInfo[d.Province_State].population * 100000) * 5, 0) + 'px';
      })
      .html((d, i) => {
